...
type Distributor interface {
	...
	LabelValuesStream(ctx context.Context, from, to int64, label string, matchers ...*labels.Matcher) storage.LabelValues
...
func (q *distributorQuerier) LabelValuesStream(ctx context.Context, name string, matchers ...*labels.Matcher) storage.LabelValues {
	...
	return q.distributor.LabelValuesStream(ctx, q.mint, q.maxt, name, matchers...)
}
